...
import hero from "../../../images/posts/hello-world/hero.jpg";

<img src={hero.src} alt="Gatsby" />
...
import gatsby from "../../../images/posts/hello-world/gatsby.png";

<img src={gatsby.src} alt="Gatsby Architecture" />
