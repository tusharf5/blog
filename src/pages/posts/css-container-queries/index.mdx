...
import Component from "../../../images/posts/css-container-queries/component.png";
...
import LargeComponent from "../../../images/posts/css-container-queries/large-screen.png";

<img src={LargeComponent.src} alt="large-screen" />
...
import MediumComponent from "../../../images/posts/css-container-queries/medium-size.png";

<img src={MediumComponent.src} alt="medium-size" />
...
import Responsiveness from "../../../images/posts/css-container-queries/responsive-comps.png";

<img src={Responsiveness.src} alt="responsive-comps" />
...
import Same from "../../../images/posts/css-container-queries/same-screen-diff-parent.png";

<img src={Same.src} alt="same-screen-diff-parent" />
