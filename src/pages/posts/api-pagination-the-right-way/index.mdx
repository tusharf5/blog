...
import APICycle from "../../../images/posts/api-pagination-the-right-way/api-cycle.png";

<img src={APICycle.src} alt="api-cycle" />
...
import IndexDesign from "../../../images/posts/api-pagination-the-right-way/mongodb-index.png";

<img src={IndexDesign.src} alt="mongodb-index" />
