...
import CloudTrailDashboard from "../../../images/posts/aws-eventbridge/cloudtrail.png";

<img src={CloudTrailDashboard.src} alt="cloudtrail" />
...
import EventBridgeCloudTrail from "../../../images/posts/aws-eventbridge/event-structure.png";

<img src={EventBridgeCloudTrail.src} alt="event-structure" />
...
import createcloudtrail from "../../../images/posts/aws-eventbridge/create-cloudtrail.png";

<img src={createcloudtrail.src} alt="create-cloudtrail" />
...
import createruleeventbridge from "../../../images/posts/aws-eventbridge/create-rule-eventbridge.png";

<img src={createruleeventbridge.src} alt="create-rule-eventbridge" />
...
import defintepatterneventbridge from "../../../images/posts/aws-eventbridge/definte-pattern-eventbridge.png";

<img src={defintepatterneventbridge.src} alt="definte-pattern-eventbridge" />
...
import selecttargetseventbridge from "../../../images/posts/aws-eventbridge/select-targets-eventbridge.png";

<img src={selecttargetseventbridge.src} alt="select-targets-eventbridge" />
