...
<img src={PublicKeyCrypto} alt="ssl lock" />
...
Instead of encrypting an entire message, a private key is used to encrypt the hash of the message, the public key on the other hand is used to decrypt the hash.
If the hash extracted from the signature matches the hash of the original message, the message is considered authentic & unaltered.
...
<img src={PrivateKeyCrypto} alt="ssl lock" />
