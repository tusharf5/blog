...
title: 'TLS Certificates - For The Rest Of Us'
category: 'TLS'
...
tags:
  ...
  - ssl handshake
  - tls handshake
excerpt: 'How does your browser know a website is legit? This post simplifies TLS, certificate validation, and the trust chain behind secure connections'
---
...
This is why **TLS** combines encryption with authentication.
...
<img src={TLSHandshake} alt="ssl lock" />
...
The TLS handshake involves multiple steps, but this post focuses on **certificate validation**, the key process that ensures you're talking to the right server.
...
<img src={TLSFullConnection} alt="ssl advertisment" />
...
<img src={TLSCertChainExample} alt="ssl lock" />
...
<img src={TLSCertChainValidation} alt="ssl lock" />
