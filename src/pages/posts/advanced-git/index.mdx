...
import AdvancedGit from "../../../images/posts/advanced-git/hero.jpg";

<img src={AdvancedGit.src} alt="Advanced Git" />
...
import GitMerge from "../../../images/posts/advanced-git/normal-merge.png";

<img src={GitMerge.src} alt="normal-merge" />
...
import CleanGitHistory from "../../../images/posts/advanced-git/straight-graph.png";

<img src={CleanGitHistory.src} alt="straight-graph" />

But when there is already some work done (e.g G and H) on the master branch like this

import RebaseA from "../../../images/posts/advanced-git/upstream-ahead.png";

<img src={RebaseA.src} alt="upstream-ahead" />

Then git performs a 3 way merge with a merge commit (e.g I).

import MergeCommit from "../../../images/posts/advanced-git/merge-commit.png";

<img src={MergeCommit.src} alt="merge-commit" />
...
import WorkDoneOnMaster from "../../../images/posts/advanced-git/upstream-ahead.png";

<img src={WorkDoneOnMaster.src} alt="upstream-ahead" />
...
import RebaseB from "../../../images/posts/advanced-git/after-rebase.png";

<img src={RebaseB.src} alt="after-rebase" />
...
import CleanMergeAfterRebase from "../../../images/posts/advanced-git/after-rebase-merge.png";

<img src={CleanMergeAfterRebase.src} alt="after-rebase-merge" />
...
```shell
a338528e {
a338528e   "name": "sample-app",
a338528e   "version": "1.2.4",
a338528e   "description": "Sample App",
a338528e   "private": true,
a338528e   "engines": {
```
