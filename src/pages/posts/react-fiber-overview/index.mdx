...
<img src={header} alt="react virtual dom" />
...
<img src={UpdateGif} alt="react update gif" />
...
<img src={StackExec} alt="stack-code-exec-timeline" />
...
<img src={FiberExec} alt="fiber-code-exec-timeline" />
