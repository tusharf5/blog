...
uid: "react-fiber-overview"
title: "React Fiber Architecture - An Overview"
category: "React"
draft: false
tags:
  - react
  - react fiber
  - react virtual dom
excerpt: "In this post I'll talk about the internal architecture of React also called the React Fiber."
---

import header from "../../../images/posts/react-fiber-overview/header.png";

<img src={header.src} alt="react virtual dom" />
...
import UpdateGif from "../../../images/posts/react-fiber-overview/tree-update.gif";

<img src={UpdateGif.src} alt="react update gif" />
...
import StackExec from "../../../images/posts/react-fiber-overview/stack-code-exec-timeline.png";

<img src={StackExec.src} alt="stack-code-exec-timeline" />
...
import FiberExec from "../../../images/posts/react-fiber-overview/fiber-code-exec-timeline.png";

<img src={FiberExec.src} alt="fiber-code-exec-timeline" />
...
> Prefer using setState functions `setState((state) => ({...}))` which guarantees you the latest state passed in arguments as opposed to passing the new state as an object to `setState({...})`
