...
import crowd from "../../../images/posts/aws-sqs/crowd.png";

<img src={crowd.src} alt="crowd" />
...
import sqslifecycle from "../../../images/posts/aws-sqs/sqs-message-lifecycle-diagram.png";

<img src={sqslifecycle.src} alt="sqs-message-lifecycle-diagram" />
...
import sqsVisibilityTimeoutDiagram from "../../../images/posts/aws-sqs/sqs-visibility-timeout-diagram.png";

<img
  src={sqsVisibilityTimeoutDiagram.src}
  alt="sqs-visibility-timeout-diagram"
/>
