...
import Stack from "../../../images/posts/aws-cfn-with-ssm-parameters/stack-mesh.png";

<img src={Stack.src} alt="Stack" />
...
import CFN from "../../../images/posts/aws-cfn-with-ssm-parameters/cfn.png";

<img
  src={CFN.src}
  alt="SSM Parameters For A Better CloudFormation Experience"
/>
...
import ServiceCalls from "../../../images/posts/aws-cfn-with-ssm-parameters/service-calls.png";

<img src={ServiceCalls.src} alt="service calls" />
...
import ApproachOne from "../../../images/posts/aws-cfn-with-ssm-parameters/approach-1.png";

<img src={ApproachOne.src} alt="approach" />
...
import SSMParamStore from "../../../images/posts/aws-cfn-with-ssm-parameters/ssm-param-store.png";

<img src={SSMParamStore.src} alt="ssm param store" />
...
import ApproachTwo from "../../../images/posts/aws-cfn-with-ssm-parameters/approach-2.png";

<img src={ApproachTwo.src} alt="approach" />
...
import SSMProblem from "../../../images/posts/aws-cfn-with-ssm-parameters/problem-ssm.png";

<img src={SSMProblem.src} alt="SSM Problem" />
...
import Solved from "../../../images/posts/aws-cfn-with-ssm-parameters/solved.png";

<img src={Solved.src} alt="solved" />
...
import SSmCFNShare from "../../../images/posts/aws-cfn-with-ssm-parameters/ssm-cfn-share-res.png";

<img src={SSmCFNShare.src} alt="ssm cloudformation cross reference" />
...
And BTW did I mention that SSM Parameter Store is [free](https://aws.amazon.com/systems-manager/pricing/) for all the above use cases 🙅🏻
