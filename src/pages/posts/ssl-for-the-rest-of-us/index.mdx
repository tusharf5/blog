...
The CA verifies your [domain ownership](https://www.thesslstore.com/knowledgebase/ssl-validation/domain-validation/) and provides a certificate that includes your public key. Now that we have an SSL certificate, let's see how it actually works to secure communication using public-key cryptography.
