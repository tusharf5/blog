...
> A **self-signed** certificate is a certitificate that is signed by its own private key instead of another CA's private key. This is typically used for Root CAs.
