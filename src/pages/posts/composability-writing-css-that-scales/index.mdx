...
import Abstraction from "../../../images/posts/composability-writing-css-that-scales/abstraction.png";

<img src={Abstraction.src} alt="abstraction" />
...
import ReusableImages from "../../../images/posts/composability-writing-css-that-scales/reusable-images.png";

<img src={ReusableImages.src} alt="reusable-images" />
